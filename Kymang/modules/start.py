...
sɪʟᴀʜᴋᴀɴ ᴋʟɪᴋ ᴛᴏᴍʙᴏʟ ᴅɪʙᴀᴡᴀʜ ɪɴɪ ᴜɴᴛᴜᴋ ᴍᴇᴍᴜʟᴀɪɴʏᴀ**</blockquote>
"""

about_msg = """
<blockquote><b>Tentang Bot ini:
...
async def start_bot(c, m):
    ...
    if len(text) > 7:
        ...
        await m.reply(
            f"<blockquote><b>👋Hello {m.from_user.mention}\n\nSaya dapat menyimpan file pribadi di Channel Tertentu "
            "dan pengguna lain dapat mengaksesnya dari link khusus</b></blockquote>",
